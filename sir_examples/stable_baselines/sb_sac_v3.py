...
for i in range(1):
    ...
    model = SAC("MlpPolicy", env, verbose=2, batch_size=64, learning_rate=2e-5, train_freq=8, tau=.02, buffer_size=int(1e5), policy_kwargs=policy_kwargs, ent_coef=0.001, POI_R0s=[2,3,4], epsilon=1, burn_in=int(0))
