...
heatmap_offsets = np.linspace(
    -offsets_for_sweep, offsets_for_sweep, heatmap_fineness
)
...
fixed_heatmap_offsets = np.linspace(
    -offsets_for_sweep, offsets_for_sweep, fixed_heatmap_fineness
)
...
inits_default = np.array([S_init_default, I_init_default, R_init_default])
